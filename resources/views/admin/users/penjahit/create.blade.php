                    ...
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Tambah Akun Penjahit</h5>
                            </div>

                            <form action="{{ route('admin.penjahit.store') }}" method="POST"
                                    ...
                                    <div class="mb-4">
                                        <h5 class="fw-bold mb-0">
                                            ...
                                            <span class="fs-12 fw-normal text-muted">
                                                Data akun penjahit yang akan dibuat
                                            </span>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Nama penjahit"
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" class="form-control" placeholder="Email penjahit"
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="password" name="password" class="form-control" id="password-input" placeholder="Password penjahit" required>
