        ...
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.penjahit.index') }}">Daftar Penjahit</a></li>
            ...
            <div class="col-span-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Akun Penjahit</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('admin.penjahit.update', $users->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mt-4 flex gap-2">
                                ...
                                <a href="{{ route('admin.penjahit.index') }}" class="btn btn-secondary">
                                    Kembali
                                </a>
                            </div>
                        </form>
